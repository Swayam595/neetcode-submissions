class Solution:
    def longestPalindromeSubseq(self, s: str) -> int:
        return self.__longestCommonSubsequence(s, s[::-1])

    def __longestCommonSubsequence(self, text1: str, text2: str) -> int:
        # return self.__recursive(text1, text2, 0, 0)
        # return self.__topDown(text1, text2)
        return self.__bottomUp(text1, text2)
        # return self.__bottomUpOptimized(text1, text2)
    ...
    # TC -> O(N * M)
    # SC -> O(M)
    def __bottomUpOptimized(self, s1: str, s2: str) -> int:
        N = len(s1)
        M = len(s2)
