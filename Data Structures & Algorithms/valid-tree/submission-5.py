...
class Solution:
    def validTree(self, n: int, edges: List[List[int]]) -> bool:
        ...
        return self.__validTreeUsingBfs(n, edges)
    ...
    def __validTreeUsingDfs(self, n: int, edges: List[List[int]]) -> bool:
        ...
        adj_dict = adj_map = self.__buildAdjMap(n, edges)
        visited = set()
    ...
    def __validTreeUsingBfs(self, n: int, edges: List[List[int]]) -> bool:
        if len(edges) > n - 1:
            return False
        
        adj_map = self.__buildAdjMap(n, edges)
    ...
    def __buildAdjMap(self, n: int, edges: List[List[int]]) -> dict:
